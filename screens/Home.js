    ...
    function renderNotice(){
        return (
            ...
            >
                ...
                <Text
                    style ={{marginTop: SIZES.base, color:COLORS.white, ...FONTS.body4, lineHeight:18}}
                >Its very difficult to time an investment, especially when the market is volatile, learn  how to use dollar cost avaraging to your advantage</Text>
                <TouchableOpacity
                    style={{
